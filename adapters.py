...
SHARED_FILES = ("problem_half.py", "problem_index.py", "problem_candidates.py",
                ...
                "source_to_notes.py", "x_posts.py", "spotify_ledger.py", "browser_ledger.py",
                "requirements-browser.txt", "browser_capture/manifest.json",
                "browser_capture/popup.html", "browser_capture/popup.js", "browser_capture/capture.mjs",
                "readera_highlights.py",
