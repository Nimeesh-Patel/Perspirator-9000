...
from cleanup_transaction import apply_cleanup, windows_recycle
...
class CleanupTransactionTests(unittest.TestCase):
    ...
    def test_exact_approval_applies_and_checkpoints(self):
        with tempfile.TemporaryDirectory(dir=Path.cwd()) as tmp:
            ...
            result = apply_cleanup(
                ...
                recycler=self._delete, capacity_checker=self._capacity)
    ...
    def test_adapter_failure_is_indeterminate_and_stops(self):
        with tempfile.TemporaryDirectory(dir=Path.cwd()) as tmp:
            ...
            result = apply_cleanup(
                ...
                recycler=fail_second, capacity_checker=self._capacity)
    ...
    def test_windows_adapter_sends_path_over_stdin(self):
        ...
        self.assertEqual(calls[0][1]["input"], str(path))
